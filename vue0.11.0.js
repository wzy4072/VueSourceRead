  ...
  return (function (modules) {
    ...
    [
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        Vue.options = {
          directives: __webpack_require__(8), // 指令 操作指令 监听指令 子组件指令
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        exports.$watch = function (exp, cb, deep, immediate) {
          ...
          if (!watcher) {
            watcher = vm._userWatchers[key] = new Watcher(
              vm,
              exp,
              wrappedCb,
              null,
        ...
        exports.$log = function (path) {
          var data = path ? Path.get(this, path) : this._data
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        exports.$addChild = function (opts, BaseCtor) {
          ...
          var ChildVue
          var inherit =
            opts.inherit !== undefined ? opts.inherit : BaseCtor.options.inherit
          if (inherit) {
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        function cleanup(vm) {
          ...
          vm._data = vm._watchers = vm._userWatchers = vm._watcherList = vm.$el = vm.$parent = vm.$root = vm._children = vm._bindings = vm._directives = null
          // call the last hook...
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        exports._init = function (options) {
          ...
          // children
          this._children = this._childCtors = null // @type {Array} // @type {Object} - hash to cache
          // child constructors

          // merge options.

        // 参数1    this.constructor.options,  指的是        
        //   Vue.options = {
        ...
        // 参数2 options 指的是 用户传参 new Vue(option)

        // 参数3 this 是 _init 产生的
      ...
      /* 14 */
      /***/ function (module, exports, __webpack_require__) {
        // 工具方法 isReserved   toString   toNumber   stripQuotes   camelize   bind   toArray   extend   isObject   isPlainObject   isArray   define
      ...
      /* 15 */
      /***/ function (module, exports, __webpack_require__) {
          // 运行环境判断 hasProto inBrowser nextTick isIE9
      ...
      /* 16 */
      /***/ function (module, exports, __webpack_require__) {
       // 事件/属性/节点 的添加删除    inDoc attr before after remove prepend replace copyAttributes on off addClass removeClass
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        strats.created = strats.ready = strats.attached = strats.detached = strats.beforeCompile = strats.compiled = strats.beforeDestroy = strats.destroyed = strats.paramAttributes = function (
          parentVal,
          childVal
        ) {
          return childVal
        ...
        strats.directives = strats.filters = strats.partials = strats.transitions = strats.components = function (
          parentVal,
          childVal,
          vm, 
          key
         ...
         *
         * @param {Object} parent   this.constructor.options,  Vue.options
         * @param {Object} child   options 用户传参 new Vue(option)
         * @param {Vue} [vm] - if vm is present, indicates this is
         *                     an instantiation merge.  _init
         */
        ...
        module.exports = {
          ...
          bind: function () {
            if (this.el !== this.vm.$el) {
              _.warn('v-ref should only be used on instance root nodes.')
              return
            }
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        exports.compileGetter = function (path) {
          var body =
            'try{return o' + path.map(formatAccessor).join('') + '}catch(e){};'
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        module.exports = function compile(el, options, partial) {
          ...
          var paramsLinkFn = params
            ...
            : null
          var nodeLinkFn =
            el instanceof DocumentFragment ? null : compileNode(el, options)
          var childLinkFn =
            (!nodeLinkFn || !nodeLinkFn.terminal) && el.hasChildNodes()
        ...
        function compileNodeList(nodeList, options) {
          ...
          for (var i = 0, l = nodeList.length; i < l; i++) {
            ...
            childLinkFn =
              (!nodeLinkFn || !nodeLinkFn.terminal) && node.hasChildNodes()
        ...
        function makeTeriminalLinkFn(el, dirName, value, options) {
          ...
          if (dirName === 'component') {
            ...
            el._parentLinker = dirs.length ? makeDirectivesLinkFn(dirs) : null
          }
        ...
        function collectDirectives(el, options, asParent) {
          ...
          while (i--) {
            ...
            if (attrName.indexOf(config.prefix) === 0) {
              ...
              if (asParent && (dirName === 'with' || dirName === 'ref')) {
                continue
              }
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        function Observer(value, type) {
          ...
          if (type === ARRAY) {
            var augment =
              config.proto && _.hasProto ? protoAugment : copyAugment
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        module.exports = {
          bind: function () {
            ...
            var number = el.hasAttribute('number') || el.type === 'number'
            if (number) {
